...
public class AuthorQueryController implements Initializable{
	@FXML
	...
	public void SearchAuthor(ActionEvent event) throws Exception{
		String Author = Search.getText();
		papers = search.GetNewPapersByAu(Author);
		page=1;
		if(1>papers.size()) {
			Text1.setText("");
		}
